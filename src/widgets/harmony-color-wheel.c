...
static void
harmony_color_wheel_set_property (GObject *object,
                                guint prop_id,
                                const GValue *value,
                                GParamSpec *pspec)
{
  HarmonyColorWheel *self = HARMONY_COLOR_WHEEL (object);
...
static void
harmony_color_wheel_snapshot (GtkWidget *widget,
                            GtkSnapshot *snapshot)
{
  HarmonyColorWheel *self =
      HARMONY_COLOR_WHEEL (widget);
...
static void
harmony_color_wheel_class_init (
    HarmonyColorWheelClass *klass)
{
  ...
  gobject_class->set_property =
      harmony_color_wheel_set_property;

  widget_class->snapshot =
      harmony_color_wheel_snapshot;
...
HarmonyColorWheel *
harmony_color_wheel_new (void)
{
  return g_object_new (
      HARMONY_TYPE_COLOR_WHEEL,
      NULL);
}
